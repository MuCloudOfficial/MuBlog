(function($){
  ...
  var defaultMode = window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light';
  applyThemeMode(savedMode || defaultMode);

  $('#theme-toggle-btn').on('click', function(){
    var nextMode = $('body').hasClass('dark-mode') ? 'light' : 'dark';
